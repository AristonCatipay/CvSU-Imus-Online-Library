...
<body>
  ...
  <div class="account-header">
    <h2>TRANSACTIONS / BOOK APPROVED REQUESTS</h2>
  </div>
...
if(isset($_POST["confirm_recieved"])){
  ...
  if($return_due_date){
    $query = "UPDATE borrow_request_student SET request_status='BORROWED', return_due_date='$return_due_date' WHERE transaction_id=$transaction_id";
