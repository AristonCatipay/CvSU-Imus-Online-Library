<!Doctype html>
  <html class="animated fadeIn">
    ...
    <div class="logo-navbar">
      <a href ="/../carlos_login_new/home-admin-staff/admin/home-admin.php"><img class="logo" src="/../cvsu-imus-online-library/file_set/css/pics/logo-text.png"></a>
      <div class="nav-bar">
          <button class="hm"><a href="/../cvsu-imus-online-library/file_set/home-admin-staff/admin/home-admin.php">Home</a></button>
            ...
            <div class="dropdown">
                <button class="dropbtn"><a href="#">Transac</a></button>
                    <div class="dropdown-content">
                        <a href="/../cvsu-imus-online-library/file_set/home-admin-staff/admin/nav-bar-links/book-request.php">Book Request</a>
                        <a href="/../cvsu-imus-online-library/file_set/home-admin-staff/admin/nav-bar-links/borrowed-books.php">Borrowed Books</a>
                        <a href="/../cvsu-imus-online-library/file_set/home-admin-staff/admin/nav-bar-links/returned-books.php">Returned Books</a>
                    </div>
            </div>
